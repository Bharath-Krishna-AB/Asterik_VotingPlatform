            ...
            <main className="w-full max-w-[420px] bg-white border border-neutral-200 rounded-[32px] p-8 md:p-10 shadow-xl shadow-black/5 mx-4 flex flex-col gap-8">
                ...
                <div className="flex flex-col items-center text-center gap-5">
                    ...
                    <div className="space-y-2">
                        <h2 className='font-clash-display font-bold text-2xl tracking-tight'>Create Account</h2>
                        <p className='text-neutral-500 text-sm leading-relaxed max-w-[280px] mx-auto'>
                            Join us to access the voting platform dashboard.
                        </p>
                    </div>
                </div>
                ...
                <div className="pt-6 border-t border-neutral-100 flex justify-center">
                    <p className='text-sm text-neutral-500 font-medium'>
                        Already have an account? <Link href="/signin" className="text-black underline underline-offset-4 decoration-2 decoration-primary hover:decoration-black transition-all">Sign In</Link>
                    </p>
                </div>
            </main>
        </div>
