                    ...
                    {filteredVoters.map((voter, i) => (
                        <div key={i} className="flex items-center justify-between p-4 rounded-xl bg-neutral-900/50 border border-neutral-800/50 hover:bg-neutral-800/80 transition-colors group">
                            <div className="flex items-center gap-4">
                                <div className="w-10 h-10 rounded-full bg-neutral-800 flex items-center justify-center border border-neutral-700 group-hover:border-primary/30 transition-colors">
                                    <User className="w-5 h-5 text-neutral-400 group-hover:text-primary" />
                                </div>
                                <div>
